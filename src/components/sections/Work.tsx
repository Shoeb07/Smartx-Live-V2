...
const projects = [
  {
    ...
    result: "Live & generating enquiries",
    resultColor: "#00e5b0",
    accent: "#6c63ff",
  ...
  },
  {
    ...
    year: "2025",
    description:
      "FurneXo is India's first furniture exchange platform enabling users to buy, sell, and swap furniture. Built to promote sustainability and affordability.",
    tags: ["Marketplace UX", "Listing Management", "Secure Transactions", "Growth Optimized"],
    highlights: [],
    result: "Live — India's first furniture exchange",
    resultColor: "#00e5b0",
    accent: "#00e5b0",
    bg: "from-[#00e5b0]/10 via-transparent to-transparent",
    type: "web",
  ...
  },
  {
    ...
    year: "2023",
    description:
      "A modern brand website for Attractions Mens Studio, a premium grooming destination offering haircuts, styling, and skincare for men in Hyderabad.",
    tags: ["Commerce Experience", "Brand-Led Design", "Customer Retention", "Conversion Focused"],
    highlights: [],
    result: "Live — premium grooming brand online",
    resultColor: "#00e5b0",
    accent: "#00e5b0",
    bg: "from-[#00e5b0]/10 via-transparent to-transparent",
    type: "web",
  ...
  },
  {
    ...
    year: "2024",
    description:
      "One Stop Dashboard is a comprehensive ERP application centralising business operations into one platform with real-time insights and workflow automation.",
    tags: ["Operations Automation", "Business Intelligence", "Real-Time Insights", "Scalable Enterprise App"],
    highlights: [],
    result: "Live — ERP platform deployed",
    resultColor: "#00e5b0",
    accent: "#00e5b0",
    bg: "from-[#00e5b0]/10 via-transparent to-transparent",
    type: "web",
